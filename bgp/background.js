...
var Preferences = {
	...
	getDefaults() {
		return {
			...
			hFlashAdVolume: 100,
			hEnergyMaxSound: false,
			hEnergyMaxSoundName: 'ui_level',
			hEnergyMaxVolume: 100,
			hLockCaravan: true,
			hNoMails: true,
			hPetFollow: false,
			hPetSpeed: false,
...
var Tab = {
	...
	showGame(options) {
		...
		const url = (site != 'facebook' ? 'https://portal.pixelfederation.com/diggysadventure/' : 'https://apps.facebook.com/diggysadventure/');
