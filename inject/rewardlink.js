...
const reFacebook = /https?:\/\/(game\.)?diggysadventure\.com\/miner\/wallpost\.php\?.*wp_id=(\d+)&fb_type=(standard|portal)&wp_sig=([0-9a-z]+)/g;
...
if (!data) {
	...
	if (match) data = getObj(match[2], match[3], match[4]);
}
